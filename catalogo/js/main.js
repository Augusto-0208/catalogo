            ...
            <div style="margin-top:1rem; background: rgba(255,255,255,0.1); border-radius:16px; padding:1.5rem;">
              <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; max-width:500px; margin:0 auto;">
                <div>
                  ...
                  <input type="text" id="lojaNome" placeholder="Nome da sua loja" style="width:100%; padding:0.5rem; border-radius:8px; border:none; background:rgba(255, 255, 255, 0.97); color:white;">
                </div>
                <div>
                  <label style="display:block; font-size:0.8rem; opacity:0.8; margin-bottom:0.3rem;">Telefone</label>
                  <input type="text" id="lojaTelefone" placeholder="(00) 00000-0000" style="width:100%; padding:0.5rem; border-radius:8px; border:none; background:rgba(255,255,255,0.97); color:white;">
                </div>
                <div style="grid-column:1/-1;">
                  <label style="display:block; font-size:0.8rem; opacity:0.8; margin-bottom:0.3rem;">Produtos de Interesse</label>
                  <textarea id="lojaProdutos" rows="2" placeholder="Quais produtos você gostaria de ter em consignado?" style="width:100%; padding:0.5rem; border-radius:8px; border:none; background:rgba(255,255,255,0.97); color:white;"></textarea>
                </div>
                <div style="grid-column:1/-1;">
