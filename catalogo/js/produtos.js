...
const PRODUTOS = [
  ...
  { id: 91, name: "Kit Impressora 3D", desc: "Consignado - Impressora Ender 3", price: "R$ 1.499,90", category: "consignado", sub: "", icon: "fa-print", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 92, name: "Resina 3D Premium", desc: "Consignado - 1L, alta definição", price: "R$ 199,90", category: "consignado", sub: "", icon: "fa-flask", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 93, name: "Filamento PLA 1kg", desc: "Consignado - diversas cores", price: "R$ 89,90", category: "consignado", sub: "", icon: "fa-circle", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 94, name: "Kit Ferramentas 3D", desc: "Consignado - 15 peças", price: "R$ 149,90", category: "consignado", sub: "", icon: "fa-tools", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 95, name: "Suporte para Impressora", desc: "Consignado - estrutura reforçada", price: "R$ 299,90", category: "consignado", sub: "", icon: "fa-cubes", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 96, name: "Kit Lâmpadas UV", desc: "Consignado - para cura de resina", price: "R$ 129,90", category: "consignado", sub: "", icon: "fa-sun", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 97, name: "Estação de Cura", desc: "Consignado - completa", price: "R$ 449,90", category: "consignado", sub: "", icon: "fa-lightbulb", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 98, name: "Kit Lixas para 3D", desc: "Consignado - 10 peças", price: "R$ 34,90", category: "consignado", sub: "", icon: "fa-sand", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 99, name: "Spray Primer 3D", desc: "Consignado - 400ml", price: "R$ 29,90", category: "consignado", sub: "", icon: "fa-spray-can", tag: "consignado", tipo: "consignado", ativo: false },
  { id: 100, name: "Kit Tintas para 3D", desc: "Consignado - 6 cores", price: "R$ 79,90", category: "consignado", sub: "", icon: "fa-paint-roller", tag: "consignado", tipo: "consignado", ativo: false },
